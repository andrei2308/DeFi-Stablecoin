...
contract DSCEngine is ReentrancyGuard {
    ...
    uint256 private constant LIQUIDATION_THRESHOLD = 50; //50% overcolateralized
    ...
    constructor(address[] memory tokenAddresses, address[] memory priceFeedAddresses, address dscAddress) {
        ...
        i_dsc = DecentralizedStableCoin(dscAddress); // i_dsc will have the reference of the DecentralizedStableCoin contract on blockchain so that we can call the functions of DecentralizedStableCoin contract
    }

    //////////////////////
    // External functions
    //////////////////////
    function depositColatteralAndMintDsc(
        address tokenCollateralAddress,
        uint256 amountCollateral,
        uint256 amountDSCToMint
    ) external {
        depositColatteral(tokenCollateralAddress, amountCollateral);
        ...
        nonReentrant
    {
        ...
        //Give the liquidator 10% bonus for liquidating
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) nonReentrant {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); //hypothetically this is never hit
    }
    ...
    function depositColatteral(address tokenCollateralAddress, uint256 amountCollateral)
        public
        moreThanZero(amountCollateral)
    ...
    function calcualteHealthFactor(uint256 totalDscMinted, uint256 amountCollateralInUsd)
        external
        pure
        returns (uint256 healthFactor)
    {
        healthFactor = _calculateHealthFactor(totalDscMinted, amountCollateralInUsd);
    }
        ...
        returns (uint256 totalDscMinted, uint256 collateralValueInUsd)
    {
        ...
        collateralValueInUsd = _getCollateralValueInUsd(user);
    }
    ...
    function _getCollateralValueInUsd(address user) public view returns (uint256 totalCollateralValueInUsd) {
        //get the value of all the collateral in USD
        //get the value of all the DSC minted by the user
